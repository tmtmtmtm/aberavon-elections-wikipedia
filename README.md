...
* wb ce create-new-party.js "Real Bean"  | jq -r '.entity.id'
* wb ce create-new-party.js "New Millennium Bean Party"  | jq -r '.entity.id'
...
Then sent to QuickStatements as https://editgroups.toolforge.org/b/QSv2T/1598427964794/
